...
<body>
    <form method="get" action="visualizarAceitos.php">
        <?php
    ...
    <div id="containerDados" class="center">
            ...
            <div class="caixa_dados center">
                    ...
                    echo($_SESSION['link']); $_SESSION['codigo'] = $rsDados['codigo'];
            ...
            <div id="aceitar_deletar2" class="center">
        ...
        //         }
                ...
                if(isset($_GET['btn_deletar'])){
                    ...
                    $sql = "delete from tblaceitos where codigo =".$_SESSION['codigo'];
