...
<body>
    ...
    <div id="containerDados" class="center">
            ...
            <div class="caixa_dados">
                <div id="titulo_habilidades">Habilidades</div>
            ...
            <div id="titulo_habilidades">Formacoes</div>
            <div class="caixa_dados center">
            ...
            <div class="caixa_links center">
                    <div id="titulo_habilidades" class="center">Links</div>
                    <div class="txtLinks">Link:<?php $_SESSION['link']=$rsDados['link'];
                    echo($_SESSION['link']); echo($_SESSION['codigo'] = $rsDados['codigo']);
                  
                    ?></div>
                    <div class="txtLinks">Link:<?php $_SESSION['link2']=$rsDados['link2']; echo($_SESSION['link2'])?></div>
                    <div class="txtLinks">Link:<?php $_SESSION['link3']=$rsDados['link3']; echo($_SESSION['link3'])?></div>
                    <div class="txtLinks">Link:<?php $_SESSION['link4']=$rsDados['link4']; echo($_SESSION['link4'])?></div>
